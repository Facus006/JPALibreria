...
public class PantallaMenu2 extends javax.swing.JFrame {

    public PantallaMenu2() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Por favor, indique el ISBN del libro.");
    ...
    private void BuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BuscarActionPerformed
        ...
        long numeroLong = Long.parseLong(id);
        Controladora s = new Controladora();
        ListadeLibros.setText( s.buscarLibro(numeroLong).toString());
